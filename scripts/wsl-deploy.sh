...
# Reuses the funded `corredor` identity and Circle's canonical testnet USDC SAC
# (issuer GBBD47IF…) as the escrow/settlement asset.
set -uo pipefail
...
SRC="corredor"
NET="testnet"
TOKEN="CBIELTK6YBZJU5UP2WWQEUCYKLPU6AUNZ2BQ4WWFEIE3USCIHMXQDAMA"   # Circle's canonical testnet USDC SAC
